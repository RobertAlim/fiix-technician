export default `
    ...
    // The initial paint happens in resizeCanvas() when ResizeObserver fires
    // its mandatory first callback, so the canvas already has its final size;
    // painting here too would draw the signature twice (issue #439).
    var dataURL = <%dataURL%>;
